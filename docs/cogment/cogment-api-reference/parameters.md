...
The client will connect to the actor port of the [Orchestrator][../cogment-components/orchestrator/orchestrator.md].
...
With a __context discovery endpoint__ there is no path in the URL, and some of the details of the service will be obtained from the context of the endpoint (i.e. where the endpoint was provided and for what).
