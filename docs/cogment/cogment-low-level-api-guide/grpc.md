...
This API is defined in `datalog.proto`. It is implemented by the data logger application using the gRPC server API, including the out-of-the-box component [`cogment-trial-datastore`](../../cogment-components/trial-datastore.md).
...
This API is defined in `model_registry.proto`. It is implemented by [`cogment-model-registry`](../../cogment-components/model-registry.md).
...
This API is defined in `trial_datastore.proto`. It is implemented by [`cogment-trial-datastore`](../../cogment-components/trial-datastore.md).
