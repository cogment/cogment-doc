...
-   `properties`: User defined key/value properties in a map/dictionary style. Key names starting with a double underscore (__) are reserved for Cogment internal use. DEFAULT: empty.
