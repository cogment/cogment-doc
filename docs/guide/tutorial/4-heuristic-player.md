...
We can now configure one of the `player` in the default trial, defined in `client/main.py`, to use the `heuristic_agent` implementation.
...
Modify the `client/main.py` file to include the above addition.
